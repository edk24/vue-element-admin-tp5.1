  ...
  <div class="app-container">
    ...
    >
      ...
      >
        <template slot-scope="{row,$index}">
          <el-button type="success" size="mini" @click="handleEdit(row)">更改库存</el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" width="500" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item v-if="selectTrain" label="培训机构">
          <el-select
            v-model="temp.master_id"
            filterable
            placeholder="请选择"
            @change="handleTempTrain()"
          >
            <el-option
        ...
        <el-form-item label="开始时间">
          <el-date-picker v-model="temp.start_time" type="date" placeholder="选择日期" />
        </el-form-item>
        <el-form-item label="结束时间">
          <el-date-picker v-model="temp.end_time" type="date" placeholder="选择日期" />
        </el-form-item>
    ...
    <el-dialog :title="textMap[dialogStatus]" width="500" :visible.sync="editDialogFormVisible">
      ...
      >
        ...
        <el-form-item label="开始时间">
          <el-date-picker v-model="temp.start_time" type="date" placeholder="选择日期" readonly />
        </el-form-item>
        <el-form-item label="结束时间">
          <el-date-picker v-model="temp.end_time" type="date" placeholder="选择日期" />
        </el-form-item>
        ...
        <el-form-item label="增加数量">
          <el-button type="primary" @click="addnum(1)">+1</el-button>
          <el-button type="primary" @click="addnum(5)">+5</el-button>
          <el-button type="primary" @click="addnum(20)">+20</el-button>
          <el-button type="primary" @click="addnum(100)">+100</el-button>
        </el-form-item>
        <el-form-item label="减少数量">
          <el-button type="primary" @click="delnum(1)">- 1</el-button>
          <el-button type="primary" @click="delnum(5)">- 5</el-button>
          <el-button type="primary" @click="delnum(20)">- 20</el-button>
          <el-button type="primary" @click="delnum(100)">- 100</el-button>
        </el-form-item>
        <el-form-item label="满减金额" prop="full_money">
          <el-input
            v-model="temp.full_money"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="diastatus">取消</el-button>
...
export default {
  ...
  methods: {
    ...
    getCourseList() {
      course
        .getlist(1, 9999, this.listQuery.master_id, this.user.id)
        .then(res => {
          this.train_id = res.data[0].train_id
    ...
    handleCreate() {
      this.resetTemp()
      if (this.user.type === 2) {
        this.temp.master_id = this.train_id
      } else {
        this.temp.master_id = ''
      }
